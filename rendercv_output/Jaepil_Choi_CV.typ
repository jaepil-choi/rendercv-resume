...
#let connections-list = (
  ...
  [#box(original-link("tel:+82-10-2589-5000")[+82 10-2589-5000])],
)
...
#two-col-entry(
  left-content: [
    #strong[KAIST College of Business], Master's, Financial Engineering
  ],
  right-content: [
    Mar 2024 – present
  ],
...
#two-col-entry(
  left-content: [
    #strong[WorldQuant Online University], Master's, Financial Engineering
  ],
  right-content: [
    Jan 2023 – present
  ],
...
#two-col-entry(
  left-content: [
    #strong[Sungkyunkwan University], Bachelor's, Global Economics \(Minor: Informatics\)
  ],
  right-content: [
    Mar 2013 – Aug 2020
  ],
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Built a platform enabling in-house dealers to design global macro \(Rates\/Equity Index\/Commodities\/FX\) strategies without coding, akin to entering Excel functions],[Applied diverse object-oriented design patterns to make strategy\/utility extensions easy; architected the system so data querying and pre\/post-processing are configurable via settings \(config\) without code changes],)
  ],
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Built a scalable factor database using CRSP & Compustat \(WRDS\) based on AQR's 'Replication Crisis' paper; developed an extensible API wrapper to mass-process and standardize daily factor data via large-scale API documentation preprocessing],)
  ],
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Developed an Excel-based corporate lending KPI calculator that supported branch manager decision-making on loan execution],[Submitted 30+ system\/process improvement proposals to the in-house suggestion portal; received 2nd place Excellence Award \(within 3 months of joining\)],)
  ],
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Researched alternative data across 4,000+ U.S. equities and built new datasets leveraging patents, news, and online indicators to support fellow quants developing low-correlation alpha strategies],[Developed long-short alpha strategies with daily rebalancing under market\/sector\/factor-neutral constraints],)
  ],
)
